...
int main(){
    ...
    SortedTestHelper::testSort("Bubble Sort 1", SortedAlgorithm::bubbleSort_1, arr1, n);
    SortedTestHelper::testSort("Bubble Sort 2", SortedAlgorithm::bubbleSort_2, arr2, n);
