...
int main(){
    ...
    SortedTestHelper::testSort("Merge Sort BU 2", SortedAlgorithm::mergeSortBU2, arr2, n);
    SortedTestHelper::testSort("Quick Sort 1", SortedAlgorithm::quickSort1, arr3, n);
    SortedTestHelper::testSort("Quick Sort 2", SortedAlgorithm::quickSort2, arr4, n);
